...
let substraction = calculator( 40, 20 )
let multiplication = calculator( 3 , 11 )
...
chamada.
*/
console.log( `O resultado da subtração é: ${substraction(function (value1,value2){
  return value1 - value2
})}` );
