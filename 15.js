...
console.log(text.replace(/Manuel Marques de Sousa/, "Guilherme Dine") );
...
console.log(text.replace(/("O Centauro de Luvas")/, function(totalCapture, frase){
...
let getMonthNumber = function(monthName){
  let months = {
    janeiro: '01',
    fevereiro: '02',
    'março': '03',
