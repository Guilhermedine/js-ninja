...
let subtraction = calculator(operationSignal1)
let multiplication = calculator(operationSignal2)
let division = calculator(operationSignal3)
let mod = calculator(operationSignal4)
...
if(sum === false){
  ...
  console.log(showOperationMessage('+', 4, 6), sum(number1, number2))
}

if(sum === false){
  console.log(showErrorMessage(operationSignal1))
}else { 
  console.log(showOperationMessage('-', 4, 6), subtraction(number1, number2))
}

if(sum === false){
  console.log(showErrorMessage(operationSignal2))
}else { 
  console.log(showOperationMessage('*', 4, 6), multiplication(number1, number2))
}

if(sum === false){
  console.log(showErrorMessage(operationSignal3))
}else { 
  console.log(showOperationMessage('/', 4, 6), division(number1, number2))
}

if(sum === false){
  console.log(showErrorMessage(operationSignal4))
}else { 
  console.log(showOperationMessage('%', 4, 6), mod(number1, number2))
}
